...
if($coin_selecter) {
   if($coin_selecter=="BTCRY") { $_SESSION['trade_coin'] = "BTCRY"; }
   //if($coin_selecter=="BTCRYX") { $_SESSION['trade_coin'] = "BTCRYX"; }
            ...
            <table>
               <tr>
                  <td>
                     ...
                     <a href="home.php?c=BTC" class="coin-link">BTCRYX/BTC</a>
                     </div>
                  </td>
                  <td style="padding-left: 20px;">
                     <div class="coin-button">
                     <a href="home.php?c=BTCRY" class="coin-link">BTCRYX/BTCRY</a>
                     </div>
                  </td>
               </tr>
            </table>
