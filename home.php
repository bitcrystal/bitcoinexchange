   ...
   <table style="width: 100%;">
      <tr>
         <td align="left" valign="top" style="padding: 5px;" nowrap>
            <table>
               <tr>
                     <?php echo "<td><div class=\"coin-button\"><a href=\"home.php?c=".$my_coins->coins_names_prefix[2]."\" class=\"coin-link\">".$my_coins->coins_names_prefix[2]."/".$my_coins->coins_names_prefix[0]."</a></div></td>"; ?>
