...
$sql = "SELECT * FROM sell_orderbook WHERE want='$coins_names_prefix[1]' and processed='1'";
$result = mysql_query($sql);
$count = mysql_num_rows($result);
if($count!=0) {
   $Query = mysql_query("SELECT amount, rate FROM sell_orderbook WHERE want='$coins_names_prefix[1]' and processed='1' ORDER BY rate ASC");
   while($Row = mysql_fetch_assoc($Query)) {
      ...
      echo '<table>
               <tr>
                  ...
                  <td colspan="4" align="right" style="padding: 2px;" nowrap>Total '.$coins_names_prefix[1].': '.$cncvalue.'</td>
               </tr><tr>
