...
$sql = "SELECT * FROM ordersfilled WHERE want='".$my_coins->coins_names_prefix[2]."' and processed='1' ORDER BY rate DESC";
...
if($count!=0) {
   ...
   $Query = mysql_query("SELECT date, action, amount, rate, total FROM ordersfilled WHERE want='".$my_coins->coins_names_prefix[2]."' and processed='1' ORDER BY id DESC");
