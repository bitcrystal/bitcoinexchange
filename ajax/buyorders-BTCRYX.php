...
$sql = "SELECT * FROM buy_orderbook WHERE want='".$my_coins->coins_names_prefix[2]."' and processed='1'";
$result = mysql_query($sql);
$count = mysql_num_rows($result);
if($count!=0) {
   $Query = mysql_query("SELECT action, amount, rate FROM buy_orderbook WHERE want='".$my_coins->coins_names_prefix[2]."' and processed='1' ORDER BY rate DESC");
   ...
   echo '<table>
         <tr>
            ...
            <td align="left" style="font-weight: bold; padding: 1px; padding-left: 10px;" nowrap>Rate ('.$my_coins->coins_names_prefix[1].')</td>
            <td align="left" style="font-weight: bold; padding: 1px; padding-left: 10px;" nowrap>Total ('.$my_coins->coins_names_prefix[1].')</td>
         </tr>'.$Buys_td.'</table>';
} else {
