...
$sql = "SELECT * FROM buy_orderbook WHERE want='BTCRY' and processed='1'";
$result = mysql_query($sql);
$count = mysql_num_rows($result);
if($count!=0) {
   $Query = mysql_query("SELECT action, amount, rate FROM buy_orderbook WHERE want='BTCRY' and processed='1' ORDER BY rate DESC");
   ...
   echo '<table>
         <tr>
            <td colspan="4" align="left" style="font-weight: bold; padding: 2px;" nowrap>Buy Orders</td>
                  ...
                  <td colspan="4" align="right" style="padding: 2px;" nowrap>Total BTCRYX: '.$cncvalue.'</td>
               </tr><tr>
            <td align="left" style="font-weight: bold; padding: 1px;" nowrap>Amount (BTCRY)</td>
            <td align="left" style="font-weight: bold; padding: 1px; padding-left: 10px;" nowrap>Rate (BTCRYX)</td>
            <td align="left" style="font-weight: bold; padding: 1px; padding-left: 10px;" nowrap>Total (BTCRYX)</td>
         </tr>'.$Buys_td.'</table>';
} else {
