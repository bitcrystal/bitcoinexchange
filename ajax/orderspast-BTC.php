<?php
error_reporting(0);
$sql = "SELECT * FROM ordersfilled WHERE want='$coins_names_prefix[0]' and processed='1' ORDER BY rate DESC";
...
if($count!=0) {
   ...
   $Query = mysql_query("SELECT date, action, amount, rate, total FROM ordersfilled WHERE want='$coins_names_prefix[0]' and processed='1' ORDER BY id DESC");
