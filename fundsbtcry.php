      ...
      if($withdraw_amount) {
         ...
         if($withdraw_amount<=$Bitcrystald_Balance) {
            ...
            if($Bitcrystald_Withdraw_From) {
               $result = minusfunds($user_session,"BTCRY",$withdraw_amount);
               $result = plusfunds($FEEBEE,"BTCRY","0.01");            // add fee to feebee account
               $Chncoind_Balance = userbalance($user_session,"BTCRY");
               ...
               if(!mysql_query("INSERT INTO transactions (id,date,username,action,coin,address,txid,amount) VALUES ('','$date','$user_session','withdraw','BTCRY','$withdraw_address','$Bitcrystald_Withdraw_From','$withdraw_amount')")){
            ...
            $withdraw_message = 'You do not have enough Bitcrystals!';
         }
      } else {
         $withdraw_message = 'No amount to withdraw was entered!';
      }
   } else {
      $withdraw_message = 'No Bitcrystal address was entered!';
   }
}
?>
<html>
      ...
      <tr>
         ...
         <td align="center" valign="top" style="padding: 5px;" nowrap>
            <table>
               ...
               <tr><tr>
                  <td align="left" style="padding: 2px; padding-left: 20px;">Deposits must have 6 confirmations to become active. There is a fee of 0.01 Bitcrystals to make a withraw.</td>
               </tr>
            </table>
            </center>
         </td>
